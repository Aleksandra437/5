...
import ru.vsu.cs.course1.tree.Task;
    ...
    public TreeDemoFrame() {
        ...
        buttonFindMax.addActionListener(actionEvent -> {
            try {
                ...
                int node = Task.getMaxLeaveValue(this.tree);
                FindLabel.setText("" + node);
            } catch (Exception ex) {
                SwingUtils.showErrorMessageBox(ex);
            }
        });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        textFieldBracketNotationTree.setText("9 (6 (4 (5), 6), 5 (, 5 (2, 8)))");
        ...
        FindLabel.setText("");
        panel8.add(FindLabel, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        buttonFindMax = new JButton();
        buttonFindMax.setText("Найти наибольшее среди листьев");
        panel8.add(buttonFindMax, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final Spacer spacer7 = new Spacer();
        panel8.add(spacer7, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
